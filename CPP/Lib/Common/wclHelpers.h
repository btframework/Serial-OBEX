...
// -------------------------------------------------------------------------- //
//                                                                            //
//   WCL Common: helper classes and functions.                                //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
/// <param name="lpszUTF8"> Pointre to a buffer that receives UTF8 encoded string. </param>
...
public:
	...
	/// <param name="Count"> Amout of bytes to read. </param>
	...
	/// <param name="Buffer"> The pointer to the memory buffer. </param>
	/// <param name="Count"> Amout of bytes to write. </param>
	...
	/// <param name="Count"> Amout of bytes to copy. </param>
	...
	/// <param name="Pos"> The new prosition. </param>
...
public:
	/// <summary> Creates new memory stream. </summary>
	CwclMemoryStream();
	/// <summary> Fres the stream. </summary>
...
/// <summary> Teh enumeration indicates whether a stream object should be
...
public:
	...
	///   method can overwrite that address with the pointer to the inteface being queried for.
	...
	/// <param name="pstm"> A pointer to the destination stream. The stream pointed to by pstm

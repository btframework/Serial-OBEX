...
// -------------------------------------------------------------------------- //
//                                                                            //
//   WCL Common: Messaging subsystem.                                         //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
#pragma region Properties
	...
	unsigned char _GetCategory() const;
	/// <summary> Gets the message category ID. </summary>
	/// <value> The message category ID. </value>
	__declspec(property(get = _GetCategory)) unsigned char Category;

	/// <summary> Gets the message ID. </summary>
	/// <returns> The message ID. </returns>
	unsigned char _GetId() const;
	/// <summary> Gets the message ID. </summary>
	/// <value> The message ID. </value>
	__declspec(property(get = _GetId)) unsigned char Id;
#pragma endregion
};
...
/// <summary> The system categoiry message base class. </summary>
...
#pragma region Properties
	...
	ULONG _GetState() const;
	/// <summary> Gets the current power state. </summary>
	/// <value> The current power state. </value>
	__declspec(property(get = _GetState)) ULONG State;
#pragma endregion
};
...
#pragma region Properties
	...
	unsigned char _GetSignal() const;
	/// <summary> Gets the thread signal ID. </summary>
	/// <value> The signal ID. </value>
	__declspec(property(get = _GetSignal)) unsigned char Signal;
#pragma endregion
};

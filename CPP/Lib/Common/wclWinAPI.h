...
// -------------------------------------------------------------------------- //
//                                                                            //
//   WCL Common: Windows data types for VS compatible.                        //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
...
typedef DWORD (__stdcall *PCM_NOTIFY_CALLBACK)(HCMNOTIFICATION hNotify, PVOID Context,
...
CONFIGRET CM_Get_Device_Interface_List(LPGUID InterfaceClassGuid, DEVINSTID pDeviceID,
	PWCHAR Buffer, ULONG BufferLen, ULONG ulFlags);
